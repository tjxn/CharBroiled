      ...
      .view.registration-view.container
        .box.row
          .col-sm-12
            ...
            form.registration-form.form-horizontal.sp-form(method='post', role='form')
                div.form-group
                  label.col-sm-4 User Type
                  .col-sm-8
                    input.form-control(type='radio', name='userType', value='Contributor', checked='true')
                    | Contributor
                    input.form-control(type='radio', name='userType', value='Viewer', checked='true')
                    | Viewer
